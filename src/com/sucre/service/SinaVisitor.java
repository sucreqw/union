...
public class SinaVisitor {
    ...
    public int doWork(int index) {
        ...
        if (!MyUtil.isEmpty(ret)) {
            ...
            if (!MyUtil.isEmpty(tid)) {
                tid = tid.replace("\\", "");
            }
            String newId = MyUtil.midWord("new_tid\":", "}", ret);
            if (!MyUtil.isEmpty(newId)) {
                ...
                if (!MyUtil.isEmpty(cookie)) {
                    ...
                    if (!MyUtil.isEmpty(ret)) {
                        ...
                        if (!MyUtil.isEmpty(uid) && !uid.equals("null")) {
                            MyUtil.print("uid:" + uid + Thread.currentThread().getName(), Factor.getGui());
                            ...
                            if (Thread.currentThread().getName().equals("ip")) {
                                MyUtil.print("要换ip了！", Factor.getGui());
                                ...
                                MyUtil.print("换完ip了！", Factor.getGui());
                                MyUtil.sleeps(2000);
                            } else {
                                MyUtil.sleeps(5000);
                            }
